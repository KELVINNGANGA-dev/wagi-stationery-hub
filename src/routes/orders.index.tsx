...
export const Route = createFileRoute("/orders/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track the status of your WAGI stationery orders." },
      { property: "og:title", content: "My Orders | WAGI - STATIONARIES" },
      { property: "og:description", content: "See order history and delivery progress." },
